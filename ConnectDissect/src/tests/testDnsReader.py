...
DnsRequestPacket =      IP(dst="192.168.5.1")/UDP()/DNS(rd=1,qd=DNSQR(qname="www.slashdot.org"))
DnsResponsePacket =     IP(dst="192.168.5.1")/UDP()/DNS(rd=1,qd=DNSQR(qname="www.slashdot.org"), an = DNSRR(rrname = "www.slashdot.org", rdata = "31.33.7.31", type='A'))
